...
match page:
    ...
    case "Methodology":
        ...
        st.write("""All of our predictions use the same polynomial format, and required hours of tweaking to get a reasonable set of trends, some states had to be manually adjusted to avoid extremely outrageous outputs, except for two:
